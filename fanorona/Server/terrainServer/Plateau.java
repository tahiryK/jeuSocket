...
import joueurServer.Player;
import echangeVersClient.ExchangeData;
import java.awt.*;
...
public class Plateau extends JPanel {
    ...
    Window window;
    Color myColor = new Color(122, 33, 143);
    Color enemyColor = new Color(204, 27, 27);
    ...
    public void setUpPlayer() {
        // Données de test
        this.me = new Player("Player 1");
        this.me.setColor(myColor);
        this.enemy = new Player("Player 2");
